...
if __name__ == "__main__":
    ...
    HTTP Headers: {'Content-Type': 'application/json; version=2.4;', 'authorization': 'Token 1231231234123412341234132412341341341332'}
    POST DATA: {'name': 'arista4', 'device_role': 3, 'device_type': 2, 'display_name': 'arista4', 'platform': 4, 'rack': 1, 'site': 1, 'status': 1}
    --------------------------------------------------------------------------------
    """
